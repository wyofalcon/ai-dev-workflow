...
WORKFLOW_FILES=(
    ...
    ".ai-workflow/scripts/restore-session.sh"
    ".ai-workflow/scripts/workflow-signals.sh"
    ".ai-workflow/scripts/pre-push-check.sh"
    ".ai-workflow/scripts/post-push.sh"
    ".ai-workflow/scripts/sync-workflow.sh"
    ".ai-workflow/config/builder-setup.sh"
