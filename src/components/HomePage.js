  ...
  const options = [
    {
      ...
      tooltip:
        "Start from scratch! CVstomize will guide you through building a professional resume step-by-step.",
    ...
    },
    {
      ...
      tooltip:
        "Already have a resume? Upload it and CVstomize will extract your information to create optimized versions.",
      action: () => navigate("/onboarding"),
      color: "#7c78d8",
      disabled: false,
    },
  ...
  return (
    ...
    >
      ...
      <Typography
        variant="body2"
        color="text.secondary"
        sx={{ mt: 2, maxWidth: 700, fontStyle: "italic" }}
      >
        Answer our questions. Zero revisions needed. Our AI creates a perfectly
        tailored resume.
      </Typography>
    </Box>
  );
