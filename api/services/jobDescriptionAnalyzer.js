...
class JobDescriptionAnalyzer {
  ...
  async analyze(jobDescription) {
    ...
    const aiResponse = await this.analyzeWithAI(jobDescription);
...
**CONTEXT:**
I'm going to ask a candidate 5 targeted questions based on this job description to gather information for their resume. The questions must be:
1. Hyper-relevant to THIS specific job (not generic)
2. Designed to extract concrete examples and achievements
3. Focused on what THIS employer actually wants (based on their exact wording)
4. Appropriate for the role type (technical vs non-technical, entry vs senior, etc.)

**JOB DESCRIPTION:**
${jobDescription}

**YOUR TASK:**
Analyze this JD deeply and return structured data + 5 custom questions.
...

{
  ...
  "questions": [
    ...
    // ... 4 more questions following same structure
  ]
}
