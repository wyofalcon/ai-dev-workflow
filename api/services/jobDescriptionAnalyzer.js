...
Respond ONLY with valid JSON (no markdown, no code blocks).`;
    ...
    try {
      ...
      if (!parsedResponse.analysis || !parsedResponse.questions ||
        ...
        console.warn('⚠️  AI response missing required fields or invalid question count, using fallback');
      ...
      console.log('✅ Gemini generated', questionCount, 'custom questions',
